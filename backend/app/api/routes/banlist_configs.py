...
from app.schemas.banlist import BanListCreate, BanListUpdate, BanListResponse
from app.utils import APIResponse

router = APIRouter(prefix="/guardrails/ban-lists", tags=["Ban Lists"])
...
def create_banlist(
    ...
    try:
        response_model = banlist_crud.create(
...
def delete_banlist(
    ...
    try:
        ...
        return APIResponse.success_response(
            data={"message": "Banlist deleted successfully"}
        )
    except HTTPException as exc:
        return APIResponse.failure_response(error=str(exc.detail))
    except Exception as exc:
