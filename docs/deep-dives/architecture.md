...
**X-API-KEY** (ban list, topic relevance, validator config endpoints):
- Multi-tenant auth validated against `KAAPI_AUTH_URL`
- Scopes access to specific `organization_id` + `project_id`
